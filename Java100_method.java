...
//(2) 반복적인 작읍을 처리해야 하는 경우 메서드로 만들어 놓으면 이후에 필요할 때 다시 ★재사용 가능
//(3) 메서드는 call할때 return 값이 존재 할 수도 있고, void 형태로 반환하지 않을 수도 있다.
//(4) 메서드 call할때 파라미터값을 넘겨 줄수도 있지만, 없이 call 할 수도 있다.
...
public class Java100_method{
	...
	public static void sum_CbR(TestNumber a){
	...
	public static void main(String[] args){
		...
		methodRvPv();	//static main 메서드에서는 static 메서드를 호출해야한다.
		methodRvPii(3,5);
		...
		Java100_method obj = new Java100_method();	//obj라는 객체 생성
		obj.noStatic();	//static이 없는 메서드 호출
